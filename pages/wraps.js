        ...
        <>
            ...
            <div className="hero min-h-screen" style={{ "background-image": "url(/wrapsHeroPhoto.png)" }}>
                ...
                <div className="hero-content text-center">
                    <div className="">
                        <h1 className="mb-10 text-white text-6xl font-bold">WRAPS</h1>
                ...
                <div className="isolate bg-white py-20 lg:px-8">
                    ...
                    <div className="p-12">
                        ...
                        <div className="mt-8 sm:text-base text-xs">
                            Car wraps are a popular and versatile method of transforming the appearance of a vehicle without altering its original paintwork. A car wrap involves applying a vinyl film to the exterior surfaces of the vehicle, providing a customized and eye-catching look. These vinyl wraps come in a wide range of colors, finishes, and textures, including matte, gloss, metallic, and carbon fiber. Car wraps not only allow for personalization and provide protection against minor scratches and UV damage to the underlying paint. Wraps can also be easily removed without causing damage to the original paint, making it a temporary and reversible modification.
